        ...
        if (descriptor instanceof SimpleFunctionDescriptor) {
            ...
            switch (accessorKind) {
                case NORMAL:
                    ...
                    break;
                case IN_COMPANION:
                    accessor = new AccessorForPropertyBackingFieldInCompanion(propertyDescriptor, contextDescriptor,
                                                                              delegateType, nameSuffix);
                    break;
                case FROM_LITERAL:
                    accessor = new AccessorForPropertyBackingFieldFromLiteral(propertyDescriptor, contextDescriptor, nameSuffix);
                    break;
            }
        }
        else {
