...
public class ExpressionCodegen extends KtVisitor<StackValue, StackValue> implements LocalLookup {
    ...
    @NotNull
    public static StackValue generateClassLiteralReference(@NotNull final JetTypeMapper typeMapper, @NotNull final KotlinType type, @Nullable final ExpressionCodegen codegen) {
