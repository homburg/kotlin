...
/*p:foo*/fun usages(i: /*p:foo*/I) {
    ...
    /*p:foo p:bar p:java.lang p:kotlin.annotation*/Obj./*c:foo.Obj*/foo()
    var ii: /*p:foo*/I = /*p:foo p:bar p:java.lang p:kotlin.annotation*/Obj
    ii./*c:foo.I*/a
    ii./*c:foo.I*/foo()
    /*p:foo p:bar p:java.lang p:kotlin.annotation*/Obj./*c:foo.Obj*/b
    val iii = /*p:foo p:bar p:java.lang p:kotlin.annotation*/Obj./*c:foo.Obj*/bar()
    iii./*c:foo.I*/foo()
    /*p:foo p:bar p:java.lang p:kotlin.annotation*/E./*c:foo.E*/X
