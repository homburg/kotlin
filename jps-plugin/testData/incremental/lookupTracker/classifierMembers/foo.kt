...
/*p:foo*/class A {
    ...
    fun foo() {
        ...
        /*c:foo.A c:foo.A.Companion p:foo p:bar p:java.lang p:kotlin.annotation*/Companion./*c:foo.A.Companion*/a
        /*c:foo.A c:foo.A.Companion p:foo p:bar p:java.lang p:kotlin.annotation*/O./*c:foo.A.O*/v = "OK"
    }
...
/*p:foo*/enum class E {
    ...
    fun foo() {
        /*c:foo.E*/a
        /*c:foo.E p:foo p:bar p:java.lang p:kotlin.annotation*/Y./*c:foo.E*/a
        /*c:foo.E*/foo()
        /*c:foo.E p:foo p:bar p:java.lang p:kotlin.annotation*/X./*c:foo.E*/foo()
    }
}
